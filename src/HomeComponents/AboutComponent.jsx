...
class AboutComponent extends Component {
  ...
  handleModeChange = () => {
    const { isCasual } = this.state;
    this.setState({ isCasual: !isCasual });
  };
    ...
    return (
      <div
        ...
        className={`section-wrapper about-section ${
          theme === 'water' ? 'about-section-water' : ''
        }`}
      >
        <h1>About Me</h1>
        ...
        <div className="about-content-wrapper">
            ...
            {isCasual ? (
              ...
              <Fade bottom spy={isCasual}>
                ...
                <p>
                  ...
                  worked on, click on one of the clients below. Or to learn more
          ...
          <div className="about-profile-container">
            <div className="profile-photo-container">
              ...
              <img
                className={
                  isCasual ? 'sunglasses-photo casual-mode' : 'sunglasses-photo'
                }
                src={sunglasses}
                alt="sunglasses"
              />
            ...
            <div className="networking-links-container">
              ...
              <a href="https://github.com/annaalescia/">
                <svg
                  role="img"
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <a href="https://codepen.io/anna_alescia/">
                <svg
                  role="img"
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <button className="primary-btn" onClick={this.handleModeChange}>
              {isCasual ? 'Back to Business' : 'Casual Mode'}
            </button>
          </div>
        </div>
      </div>
